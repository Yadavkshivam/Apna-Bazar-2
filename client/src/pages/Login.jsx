        ...
        <section className='min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 flex items-center justify-center p-4 relative overflow-hidden'>
            ...
            <div className='w-full max-w-md relative z-10'>
                ...
                <div className='bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/50 transform hover:scale-[1.01] transition-all duration-500'>
                    ...
                    <div className="bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 p-6 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-green-100 text-sm mt-1">Sign in to continue shopping</p>
                        </div>
                    </div>
                    ...
                    <form className='p-6 md:p-8 space-y-5' onSubmit={handleSubmit}>
                        ...
                        <div className='group'>
                            ...
                            <Link to="/forgot-password" className='text-sm text-green-600 hover:text-green-700 font-medium mt-2 inline-block float-right transition-colors'>
                                Forgot password?
                            </Link>
                        </div>
                        ...
                        <button 
                            ...
                            className={`w-full py-3.5 rounded-xl font-bold text-white shadow-lg transition-all duration-300 flex items-center justify-center gap-2 mt-8
                        ...
                        <p className='text-center text-gray-600'>
                            ...
                            <Link to="/register" className='font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-teal-500 transition-all duration-300'>
                                Create Account
                            </Link>
                        </p>
                    </form>
                ...
                <p className="text-center text-gray-500 text-xs mt-6">
                    Secure login powered by Apna Bazar 🔒
                </p>
            </div>
        </section>
    )
